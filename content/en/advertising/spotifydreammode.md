---
draft: false
title: 'Spotify Dream Mode'
description: 'Audiobooks that pause when you fall asleep'
cover:
    image: img/dream_mode/headphonesinbed.jpg
summary: Audiobooks that pause when you fall asleep
variant: "case"
layout: wide
...
### Brief: Help Spotify enter the market of audiobooks
### Insight: Many people listen to audiobooks before falling asleep
### Solution: Audiobooks that pause when you fall asleep
...
{{< slider >}}
{{< slide type="video" src="img/dream_mode/dm_film.mp4" poster="img/dream_mode/dm_film_cover.png" caption="" >}}
{{< slide type="image" src="img/dream_mode/dm_billboard.png" caption="" >}}
{{< /slider >}}
...
---
##### ``BERGHS 2022`` ``COPYWRITER`` ``ADAM LUNDGREN`` ``ELIAS KARLSSON`` ``ART DIRECTOR`` ``CHRISTOPHER RUNSTRÖM`` ``FILIP XU``
---
